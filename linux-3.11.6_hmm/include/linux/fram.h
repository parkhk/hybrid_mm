...
//read
extern inline unsigned long fram_pages_in(struct page *dram_page, struct page *flash_page);
//write
extern inline unsigned long fram_pages_out(struct page *dram_page, struct page *flash_page);
